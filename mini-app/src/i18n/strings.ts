...
export const STR = {
  ...
  courierMapTitle: "Yetkazib berish xaritasi",
  courierEta: "~{min} daqiqada yetib boradi",
  courierDistance: "{km} km uzoqlikda",
  courierNoLocation: "Kuryer yo'lda — joylashuv hali ulashilmagan",
  courierLocationStale: "Oxirgi joylashuv: {min} daqiqa oldin",
  courierMultipleOrders: "Sizdan oldin yana bir yetkazma bor",
